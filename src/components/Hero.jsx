	...
	<section
		...
		<div
			...
			<p className={`${styles.paragraph} max-w-[470px] mt-5`}>
				Our team of experts uses a methodology to identify the method 
				most likely to fit your needs. We examine the interest of users
				and provide investment accordingly
			</p>
		</div>
